...
//    }
//    //Create folder to store categoty images from API
//    func createFolder(){
//        
...
//        //   self.arrayTableViewData.removeAll()
//        tappedMarker = marker
//        //print(marker.position as Any)
...
//                    customInfoWindow.btn2.addTarget(self, action: #selector(self.pressButton1(_:)), for: .touchUpInside)
...
//        
//    }//The target function
//    @objc func pressButton1(_ sender: UIButton){ //<- needs `@objc`
//        //print("\(sender)")
//        
...
//        }
//        
//        //Set info button on map with their following sizes
//        let infoButton = UIButton(type: .custom)
//        if Device.IS_IPHONE {
//            
//            infoButton.frame = CGRect(x: 10, y: 10, width: 35, height: 35)
//        }
//        else {
//            
//            infoButton.frame = CGRect(x: 30, y: 20, width: 50, height: 50)
//        }
//        
//        infoButton.addTarget(self, action: #selector(HomeViewController.infoAction), for: .touchUpInside)
//        infoButton.setImage(UIImage(named: "info"), for: .normal)
//        // outletMapView.addSubview(infoButton)
//    }
//    
//    //Info button on map
...
//        
//        self.outletMapView.hideAllToasts()
//        self.outletMapView.makeToast("Distance displayed may not be accurate".localized())
//    }
//    
//    //Menu button action
...
//            
//            self.outletMapView.hideAllToasts()
//            //   self.outletListView.makeToast(Validation.validityImage.localized())
//            
//            
...
//                //                let refreshAlert = UIAlertController(title: "Your Tags", message: "It looks like there are no Tags in your area.Why dont you create one?.", preferredStyle: UIAlertControllerStyle.alert)
//                //
//                //                refreshAlert.addAction(UIAlertAction(title: "Create Tag", style: .default, handler: { (action: UIAlertAction!) in
...
//        //print(indexPath.row)
//        var value = self.arrayTableViewData[indexPath.row]
//        let marker = UserDefaults.standard.string(forKey: "marker")
//        
//        
//        //        let mainStoryboard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
...
//            cell?!.delegate = self
//            //    cell?!.outletGiftNowLabel.tag = indexPath.row
//            //   cell.button.tag = indexPath.row
//            //        cell?!.outletGiftNowLabel.addTarget(self, action: #selector(buttonAction(_:)), for: .touchDown)
//            
//            return cell!!
//        }
//    }
...
//        
//    }
//    //Load Sos marker location from server data
...
//    }
//    
//    //check if user has an own group then only show resources on map

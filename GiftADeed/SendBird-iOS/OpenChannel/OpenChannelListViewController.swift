...
class OpenChannelListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource,InternetStatusIndicable, CreateOpenChannelViewControllerDelegate, ConnectionManagerDelegate {
...
self.navigationItem.title = "Inspire Community".localized()
        ...
        let leftBackItem = UIBarButtonItem(image: UIImage(named: "menu"), style: UIBarButtonItemStyle.done, target: self, action: #selector(back))
    ...
    @objc private func refreshChannelList() {
        ...
        self.openChannelListQuery?.limit = 1

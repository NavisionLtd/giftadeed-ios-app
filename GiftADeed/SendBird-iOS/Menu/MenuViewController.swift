...
//
        ...
        //Bundle.sbLocalizedStringForKey(key: "DisconnectButton")
        let rightDisconnectItem = UIBarButtonItem(title: "Cancel", style: UIBarButtonItemStyle.plain, target: self, action: #selector(disconnect))

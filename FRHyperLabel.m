...
//FRHyperLabelLinkColorDefault = [UIColor colorWithRed:255/255.0 green:69/255.0 blue:0/255.0 alpha:1];
//FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:255/255.0 green:69/255.0 blue:0/255.0 alpha:1];
...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
        FRHyperLabelLinkColorDefault = [UIColor orangeColor];
        FRHyperLabelLinkColorHighlight = [UIColor orangeColor];
	}
}

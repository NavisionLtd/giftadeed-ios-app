...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ANLoader/ANLoader.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EFInternetIndicator/EFInternetIndicator.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MMDrawController/MMDrawController.framework"
